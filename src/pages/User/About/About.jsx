      ...
      <Layout>
        <main>
          ...
          <section className="bg-gradient-to-r from-indigo-50 to-purple-50 relative overflow-hidden">
            <div className="text-center mt-10 pt-24 mb-12 relative z-10">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                About LunarIT
              </h1>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                We're on a mission to bridge the gap between academic learning and industry experience,
                creating the next generation of tech innovators.
              </p>
            </div>
          </section>
